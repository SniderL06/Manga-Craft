...
const SCENE_MAP = [
  ...
  ['grita a|gritando con', 'yelling, shouting with wide open mouth, intense expression, furious face'],
  ...
  ['apuñala por la espalda|apuñala a por la espalda|apuñalar por la espalda|apuñalando por la espalda', 'holding a sharp steel blade close behind the back of the other character, thrusting metallic tip into back, physical strike from behind, betrayal scene, dramatic shock expression, liquid spray, classic action manga panel, speed lines'],
  ['apuñala|apuñalar|apuñalando|apuñalo|le clava un cuchillo|le clava la daga', 'thrusting a sharp metallic blade into target torso, close physical combat impact, holding a shiny dagger, high tension confrontation, dynamic action pose, combat shock face, dramatic ink style, fluid spray'],
  // Efectos de impacto y ambiente de pelea / GORE y Violencia Extrema (¡NUEVO!)
  ['sangra por la cabeza|sangrando de la cabeza|cabeza sangrando', 'dark liquid trickling down face from head, forehead injury, combat damage, dramatic pain expression, liquid spray, high contrast shadows'],
  ['le corta el brazo|pierde un brazo|brazo cortado|corta el brazo a', 'severed limb impact, arm detached from shoulder, dramatic liquid spray, extreme battle damage, intense injury, dark dramatic illustration style'],
  ['le corta la cabeza|decapita a|decapitado|cabeza cortada', 'decapitation action, head detached, high impact metallic slash, liquid spray, combat scene, fantasy illustration'],
  ['cuerpo sin vida|yace muerto|muerto en el suelo', 'character lying completely defeated on the ground, unconscious pose, motionless figure on floor, dark somber atmosphere'],
  ['sangre salpica|salpicadura de sangre|lleno de sangre', 'splashing liquid droplets, dynamic liquid spray on background, covered in dark fluid, battlefield impact, high contrast splatters'],
  ['herida abierta|corte profundo|tajo profundo', 'deep metallic slash mark, gaping tissue cut, heavily damaged outfit, battle scars, high contrast shading'],
  ['corta con la espada|le da un tajo con la espada|corta con espada', 'swinging a shiny katana blade at target, steel weapon contact, dynamic sword motion, weapon trails, physical impact lines'],
  ...
  ['le golpean|golpean|le pegan|golpeando|le golpea|le pega', 'violent physical beating, adult hitting child, punch impact connecting to face, fist striking, pain expression on child face, action lines, impact flash, manga violence panel, aggressor looming over victim'],
  ['da una paliza|le da una paliza|propina una paliza|golpiza', 'brutal beating, multiple punches hitting body, character curled on floor getting kicked, attacker standing over victim, blood from face, torn clothes, intense combat damage, impact lines, dark dramatic manga'],
  ['abofetea|le da una bofetada|le da una cachetada|cachetada', 'open hand slap impact, head snapping to side, cheek struck, tears flying from impact, pain expression, impact lines, physical hit'],
  ['le patea|le da patadas|pateando', 'kicking the character on the ground, boot striking ribs, victim curled up, attacker mid-kick, impact flash, pain expression, manga action lines'],
  ['lo lanza contra la pared|lo estrella contra la pared|golpea contra la pared', 'thrown into wall, back slamming wall, impact cracks, debris flying, pain expression, body impact, dramatic action'],
