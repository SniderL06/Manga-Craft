...
const SCENE_MAP = [
  ...
  ['le golpean|golpean|le pegan|golpeando|le golpea|le pega', 'crying in pain on the floor, hands covering face, bruised cheeks, towering dark shadow of an angry parent standing over the child, dramatic silhouette of a raised hand, emotional distress, intense shadows, high contrast dramatic manga scene, speed lines of impact'],
  ['maltrato|abuso familiar|abuso domestico', 'abusive environment, sad child crying on the dark room floor, shadows of angry parents towering over him, dark somber dramatic manga, high contrast shadows, emotional trauma visual representation'],
